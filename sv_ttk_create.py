...
class Create_Frame(ttk.Frame):
    def __init__(self, parent):
        ...
        # ! ---------------------------------------------------------------------------------------------------
        self.initial_create_frame = ttk.Frame(self)
        self.initial_create_frame.grid_columnconfigure(0, weight=0)
        self.initial_create_frame.grid_rowconfigure(0, weight=0)
        
        # self.plus_icon = ttk.Image(light_image=Image.open(os.path.join(image_path, "w_plus.png")), size=(25,25))
        
        self.create_character_button = ttk.Button(self.initial_create_frame, 
        ...
        # ! ====================================================
        self.creation_frame = ttk.Frame(self) # grid() initializer is included in show_character_creation()
        ...
        # ! ====================================================
        # self.character_aspects_var = ttk.StringVar(value="Definitions") # Variable to set the default segmented button selection
        # self.character_aspects = ttk.SegmentedButton(self.creation_frame, 
        #                                                           height=40, 
        #                                                           values=["Definitions", "Long Description", "Short Description", "Greeting"], 
        #                                                           command=self.seg_butt_test)
        ...
        # ! ====================================================
        self.count_frame = ttk.Frame(self.creation_frame)
        ...
        self.char_def_counter = ttk.Label(self.count_frame, text="Character Count: 0 / 3200", anchor="w")
        ...
        self.char_count_progress = ttk.Progressbar(self.count_frame)
        ...
        # ! ====================================================
        self.definition_frame_buttons = ttk.Frame(self.creation_frame)
        ...
        self.add_button = ttk.Button(self.definition_frame_buttons, 

                                                   text="Definition", 
                                                   command=self.add_definition) 
        self.add_button.grid(row=0, column=0, pady=5, sticky="e")
        
        # * Button to select definitions
        self.select_button = ttk.Button(self.definition_frame_buttons, 

                                                      text="Select", command=self.select_definitions)
        self.select_button.grid(row=0, column=1, padx=10, pady=5, sticky="w")
        
        # * Button to delete definitions
        self.delete_def_butt = ttk.Button(self.definition_frame_buttons, 
        ...
        # ! ====================================================
        self.my_frame = ttk.Frame(self.creation_frame, width=1920, height=1080)
        ...
        self.textbox = ttk.Entry(self.creation_frame, width=300)
        ...
        # self.tabview_def = ttk.Tabview(self.creation_frame, width=300, height=230)
        ...
        self.def_type_frame = ttk.Frame(self.creation_frame)
        ...
        self.def_type_label = ttk.Label(self.def_type_frame, text="Definition Type", 
                                                    
                                                      anchor="center")
        self.def_type_label.grid(row=0, column=0, padx=10, pady=10, sticky="news")        
        
        # self.Hardcoded_rad = ttk.RadioButton(master=self.def_type_frame, 
        #                                                   radiobutton_width=25, radiobutton_height=25, width=1, height=1, 
        #                                                    text="Hardcoded — []", variable=self.variable, value=0)
        # self.Hardcoded_rad.grid(row=1, column=0, padx=10, pady=10, sticky="news")       
         
        # self.Context_rad = ttk.RadioButton(master=self.def_type_frame, 
        #                                                 radiobutton_width=25, radiobutton_height=25, width=1, height=1, 
        #                                                  text="Context — (())", variable=self.variable, value=1)
        # self.Context_rad.grid(row=2, column=0, padx=10, pady=10, sticky="news")
        
        # self.Variable_rad = ttk.RadioButton(master=self.def_type_frame, 
        #                                                  radiobutton_width=25, radiobutton_height=25, width=1, height=1, 
        #                                                   text="Variable — {}", variable=self.variable, value=2)
        ...
        self.textbox_buttons = ttk.Frame(self.creation_frame)
        self.textbox_buttons.grid(row=5, column=2, padx=(10,20), pady=(10,20), sticky="se")
        
        self.def_save_butt = ttk.Button(self.textbox_buttons, 
        ...
        self.def_edit_butt = ttk.Button(self.textbox_buttons, 
    ...
    def add_definition(self):   
        ...
        # self.test_add[self.butt_num] = ttk.Frame(self.my_frame, height=40, width=2000, fg_color="#F9F9FA")
        ...
        # ===========================
        self.frame_definitions[self.butt_num] = ttk.Frame(self.my_frame, height=40, width=2000)
        ...
        # ===========================        
        # self.bg_button_names[self.butt_num] = ttk.Button(master=self.frame_definitions[self.butt_num], height=40, width=2000, corner_radius=2,
        ...
        # ===========================        
        self.my_definitions[self.butt_num] = ttk.CheckBox(master=self.my_frame, width=1, height=1, border_width=4, state="disabled", text_color="gray10", text="ttk is a python UI-library based on Tkinter, which provides new, modern and fully customizable widgets. They are created and used like normal Tkinter widgets and can also be used in combination with normal Tkinter elements. The widgets and the window colors either adapt to the system appearance or the manually set mode ('light', 'dark'), and all ttk widgets and windows support HighDPI scaling (Windows, macOS). With ttk you'll get a consistent and modern look across all desktop platforms (Windows, macOS, Linux).")
        self.my_definitions[self.butt_num].grid(row=self.butt_num, column=0, padx=(5,2), pady=0, sticky="news")
       
        # self.label_definitions[self.butt_num] = ttk.Entry(self.frame_definitions[self.butt_num], placeholder_text="Entry")
        # self.label_definitions[self.butt_num].grid(row=self.butt_num, column=0, padx=(5,2), pady=0, sticky="news")
        
        
        # self.label_definitions[self.butt_num] = ttk.Label(self.frame_definitions[self.butt_num], text_color="gray10", text="ttk is a python UI-library based on Tkinter, which provides new, modern and fully customizable widgets. They are created and used like normal Tkinter widgets and can also be used in combination with normal Tkinter elements. The widgets and the window colors either adapt to the system appearance or the manually set mode ('light', 'dark'), and all ttk widgets and windows support HighDPI scaling (Windows, macOS). With ttk you'll get a consistent and modern look across all desktop platforms (Windows, macOS, Linux).", font=ttk.Font(size=17), anchor="w")
        # self.label_definitions[self.butt_num].grid(row=self.butt_num, column=0, padx=(5,2), pady=0, sticky="news")
        ...
        # ===========================        #F9F9FA
        # self.button_definitions[self.butt_num] = ttk.Button(master=self.frame_definitions[self.butt_num], height=40, width=2000,
        #                                                                  fg_color="transparent", text="ttk is a python UI-library based on Tkinter, which provides new, modern and fully customizable widgets. They are created and used like normal Tkinter widgets and can also be used in combination with normal Tkinter elements. The widgets and the window colors either adapt to the system appearance or the manually set mode ('light', 'dark'), and all ttk widgets and windows support HighDPI scaling (Windows, macOS). With ttk you'll get a consistent and modern look across all desktop platforms (Windows, macOS, Linux).", font=ttk.Font(size=17), text_color="gray10", 
